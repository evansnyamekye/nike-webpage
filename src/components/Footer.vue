        ...
        <div class="footer__container bd-grid">
            ...
            <div class="footer__box">
                ...
                <ul>
                    ...
                    <li><a href="#" class="footer__link"></a>FAQ'S</li>
                    <li><a href="#" class="footer__link"></a>News</li>
            ...
            <div class="footer__box">
                ...
                <ul>
                    ...
                    <li><a href="#" class="footer__link"></a>Partner w/ us</li>
                    <li><a href="#" class="footer__link"></a>Blog</li>
